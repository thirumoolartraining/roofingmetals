...
const CheckoutPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (deliveryOption === 'delivery' && (!customerDetails.address || !customerDetails.pincode || !customerDetails.city || !customerDetails.state)) {
      toast({
                    ...
                    <div className="bg-gray-50 p-6 rounded-lg max-w-md mx-auto text-left mb-8">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">#{(Math.random() * 1000000).toFixed(0).padStart(6, '0')}</span>
                        </div>
                        <div className="flex justify-between">
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                  ...
                  <div className="p-6 border-t border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <button
                        type="button"
                        className={`p-4 text-center rounded-lg border transition-colors ${paymentMethod === 'card' ? 'border-roofing-blue bg-blue-50 text-roofing-blue font-medium' : 'border-gray-200 hover:border-gray-300'}`}
                      ...
                      <button
                        type="button"
                        className={`p-4 text-center rounded-lg border transition-colors ${paymentMethod === 'upi' ? 'border-roofing-blue bg-blue-50 text-roofing-blue font-medium' : 'border-gray-200 hover:border-gray-300'}`}
                      ...
                      <button
                        type="button"
                        className={`p-4 text-center rounded-lg border transition-colors ${paymentMethod === 'cod' ? 'border-roofing-blue bg-blue-50 text-roofing-blue font-medium' : 'border-gray-200 hover:border-gray-300'}`}
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="border-t border-gray-200 pt-3 mt-3">
                          <div className="flex justify-between text-base font-medium text-gray-900">
                            <span>Total</span>
                            <span>₹{(paymentMethod === 'cod' ? orderTotal + 50 : orderTotal).toLocaleString()}</span>
                          </div>
                        </div>
                      </div>
                    </div>
