...
const getImageUrl = (image: string) => {
  // In development or if the image is already a full URL, return as is
  if (import.meta.env.DEV || image.startsWith('http')) {
    return image;
  }
  // In production, ensure the path is relative to the public directory
